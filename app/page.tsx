  ...
  return (
    <main className="mx-auto bg-[#03040B] flex flex-col items-center justify-center p-6 md:p-12 lg:p-24 min-h-screen">
      <div className="flex flex-col space-y-4 text-center">
        ...
        <h1 className="z-10 text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold text-transparent duration-100 bg-white cursor-default whitespace-nowrap bg-clip-text bg-gradient-to-r from-indigo-500 via-sky-500 to-emerald-500 animate-fadeIn">
